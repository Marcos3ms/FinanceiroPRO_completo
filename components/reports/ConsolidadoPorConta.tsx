    ...
    <div className="flex flex-col gap-8">
      {accounts.map((acc) => {
        ...
        return (
          ...
          >
            <header className="grid grid-cols-1 gap-2 border-b border-border bg-bg-elevated px-5 py-3 md:grid-cols-3">
              <div className="min-w-0">
                <div className="eyebrow">Empresa</div>
                <div className="font-display truncate text-[0.95rem] font-medium text-fg-primary">
                  {companyName ?? "—"}
                </div>
              </div>
              <div className="min-w-0 text-center">
                <div className="eyebrow">Relatório</div>
                <div className="font-display text-[0.95rem] font-medium text-fg-primary">
                  Receita e Despesa
                </div>
              </div>
              <div className="min-w-0 text-right">
                <div className="eyebrow">Período</div>
                <div className="num-mono text-[0.9rem] font-medium text-accent">
                  {periodLabel}
                </div>
              </div>
            </header>

            <div className="border-b border-border px-5 py-2 text-[0.85rem]">
